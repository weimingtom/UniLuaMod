...
namespace UniLua
{
	...
	/// </summary>
	public delegate TResult LuaFunc<TResult>();
	public delegate TResult LuaFunc<T, TResult>(T arg);
	public delegate TResult LuaFunc<T1, T2, TResult>(T1 arg1, T2 arg2);
	public delegate TResult LuaFunc<T1, T2, T3, TResult>(T1 arg1, T2 arg2, T3 arg3);
	public delegate TResult LuaFunc<T1, T2, T3, T4, TResult>(T1 arg1, T2 arg2, T3 arg3, T4 arg4);
	...
	public interface ILuaAuxLib
	{
		...
		T 		L_Opt<T>( LuaFunc<int,T> f, int n, T def );
	...
	public partial class LuaState
	{
		...
		{
			ThreadStatus status = L_LoadString( s );
